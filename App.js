...
export default PDFExample = () => {
  const sourceUrl = "http://www.africau.edu/images/default/sample.pdf?fbclid=IwAR0_sp7AS7w_6aNbHPV-tYuSd3XSo5vdE6neV-r3Q2Wm17GbWKPzIcoWNNc";
    ...
    <View style={styles.container}>
      { getSignaturePad ? (
        ...
        <View>
          { filePath ? (
            <View>
              <Text style={styles.headerText}>PDF Signature by aly faraj</Text>
              <Pdf
                minScale={1.0}
                maxScale={1.0}
                scale={1.0}
